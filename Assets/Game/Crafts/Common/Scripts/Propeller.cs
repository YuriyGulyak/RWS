...
namespace RWS
{
    public class Propeller : MonoBehaviour
    {
        ...
        public void UpdateState( float upstreamSpeedMs, float rpm )
        {
            this.upstreamSpeed = upstreamSpeedMs;
            this.rpm = rpm;
            ...
            forwardSpeed = ( rpm / 60f ) * pitchInMeteers - upstreamSpeedMs;
        ...
        void OnDrawGizmos()
        {
            ...
            for( var i = 0; i < bladeCount; i++ )
            {
                ...
                Gizmos.DrawWireCube( Vector3.right * ( radiusInMeteers - bladeScale.y / 2f ),
                    new Vector3( bladeScale.y, bladeScale.x, 0f ) );
            }
