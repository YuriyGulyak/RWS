...
public class OrbitCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        smoothedSpeed.x = Mathf.SmoothDamp( smoothedSpeed.x, rotationSpeed.x * xDirection, ref xVelocity, rotationSpeedSmooth.x );
        smoothedSpeed.y = Mathf.SmoothDamp( smoothedSpeed.y, rotationSpeed.y, ref yVelocity, rotationSpeedSmooth.y );
        ...
        smoothedFovSpeed = Mathf.SmoothDamp( smoothedFovSpeed, fovSpeed * fovDirection, ref fovVelocity, fovSmoothTime );
